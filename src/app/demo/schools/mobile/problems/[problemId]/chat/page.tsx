...
export default function SchoolsProblemChatPage() {
	...
	const [messages, setMessages] = useState<ChatMessage[]>([
		{
			...
			role: "other",
			text:
				"Hej wszyscy! Widziałem że fontanna znowu nie działa 😬 Ktoś już zgłaszał to do dyrekcji?",
		},
		{
			id: "m2",
			role: "other",
			text: "Tak, pisałam do pani dyrektor w zeszłym tygodniu. Nadal czekam na odpowiedź.",
		},
		{
			id: "m3",
			role: "other",
			text: "Może sami coś zrobimy? Mój tata zna się na hydraulice. Tylko nie wiem czy wolno 🤔",
		},
		{
			id: "m4",
			role: "self",
			text:
				"Super pomysł! Udostępniłem też link w grupie rodziców na FB. Mam nadzieję że więcej osób się włączy.",
		},
	]);
	...
	return (
		<div className="flex flex-col h-dvh w-full bg-[#141414] text-white">
			...
			<div className="relative z-10 px-3 pt-20 pb-2 flex-shrink-0">
				<ProblemPillNav problemId={problem.id} active="chat" context="schools" />
			</div>
