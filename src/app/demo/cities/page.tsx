...
export default function CitiesPlatformSelector() {
        ...
        >
          ...
          >
            <div className="flex items-center gap-4 mb-3">
              ...
              <div className="text-lg font-medium">Mobile App</div>
            </div>
            <div className="text-sm text-white/60 ml-12">
              Citizen-focused interface for reporting municipal issues and proposing community solutions
            </div>
          </button>
        </Link>

        <Link
          href="/demo/cities/desktop"
          className="block w-full"
        >
          <button 
            className={`w-full py-6 px-6 rounded-2xl border border-white/10 bg-white/5 hover:bg-white/10 hover:scale-[1.02] transition-all duration-200 text-left transform ${
          ...
          >
            <div className="flex items-center gap-4 mb-3">
              ...
              <div className="text-lg font-medium">Municipal Dashboard</div>
            </div>
            <div className="text-sm text-white/60 ml-12">
              Administrative interface for city officials to track community engagement and manage solutions
            </div>
          </button>
        </Link>
      </div>
