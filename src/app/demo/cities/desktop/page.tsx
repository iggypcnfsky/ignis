...
export default function CitiesDesktopDashboard() {
  ...
  const stats = {
    ...
    activeCitizens: demoLeaderboard.length,
    engagementRate: 82,
    solutionImplementation: 67
  };
      ...
      <header className="border-b border-white/10 bg-black/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-medium">Ignis for Cities</h1>
              <p className="text-sm text-white/60">Municipal Dashboard</p>
            </div>
          </div>
          <Link 
            href="/demo/cities"
        ...
        >
          ...
          <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-sm text-white/60">Town Halls</span>
            </div>
            <div className="text-2xl font-semibold">{stats.totalMeetups}</div>
            <div className="text-xs text-green-400 mt-1">+4% this month</div>
          </div>

          <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
            <div className="flex items-center gap-3 mb-2">
              <Users size={20} className="text-purple-400" />
              <span className="text-sm text-white/60">Active Citizens</span>
            </div>
            <div className="text-2xl font-semibold">{stats.activeCitizens}</div>
          ...
          <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
            ...
            <div className="mt-4 flex flex-wrap gap-4 text-xs">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-white/60">Medium Priority (4)</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-yellow-400 rounded-full"></div>
                <span className="text-white/60">Low Priority (2)</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                <span className="text-white/60">Resolved (1)</span>
              </div>
            </div>
          </div>
        </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 text-xs text-white/50">
                          <span>{relatedIdeas.length} citizen solutions</span>
                          <span>{relatedMeetups.length} town halls scheduled</span>
                          <span>Reported {problemIndex === 0 ? '2h ago' : problemIndex === 1 ? '4h ago' : problemIndex === 2 ? '1d ago' : '2d ago'}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                    ...
                    <div className="p-6 border-r border-white/10">
                      <h5 className="text-sm font-medium text-yellow-400 mb-4 flex items-center gap-2">
                        <Lightbulb size={16} />
                        Citizen Solutions ({relatedIdeas.length})
                      </h5>
                      {relatedIdeas.length > 0 ? (
                        ...
                        <div className="text-center py-6 text-white/40">
                          ...
                          <p className="text-sm">No citizen solutions yet</p>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="p-6">
                      <h5 className="text-sm font-medium text-blue-400 mb-4 flex items-center gap-2">
                        <Calendar size={16} />
                        Related Town Halls ({relatedMeetups.length})
                      </h5>
                      {relatedMeetups.length > 0 ? (
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2 text-xs">
                                      ...
                                      <span className="text-purple-400">{meetup.participants} citizens</span>
                                    </div>
                        ...
                        <div className="text-center py-6 text-white/40">
                          ...
                          <p className="text-sm">No town halls scheduled yet</p>
                        </div>
                      )}
                    </div>
                  </div>
