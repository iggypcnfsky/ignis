...
export default function BusinessProblemChatPage() {
	...
	const [messages, setMessages] = useState<ChatMessage[]>([
		{
			...
			role: "other",
			text:
				"Hey team! Just noticed the meeting room booking system is down again 😬 Anyone else having issues?",
		},
		{
			id: "m2",
			role: "other",
			text: "Yeah, been trying to book a room for tomorrow's client call. System keeps crashing.",
		},
		{
			id: "m3",
			role: "other",
			text: "Maybe we can set up a shared calendar as a temporary solution? I can create one in Google Workspace 🤔",
		},
		{
			id: "m4",
			role: "self",
			text:
				"Great idea! Also shared this with IT support. Hoping they can prioritize a fix.",
		},
	]);
	...
	return (
		<div className="flex flex-col h-dvh w-full bg-[#141414] text-white">
			...
			<div className="relative z-10 px-3 pt-20 pb-2 flex-shrink-0">
				<ProblemPillNav problemId={problem.id} active="chat" context="business" />
			</div>
