...
export default function BusinessPlatformSelector() {
        ...
        >
          ...
          >
            ...
            <div className="text-sm text-white/60 ml-12">
              Employee-focused interface for reporting workplace issues and proposing solutions
            </div>
          </button>
        </Link>

        <Link
          href="/demo/business/desktop"
          className="block w-full"
        >
          <button 
            className={`w-full py-6 px-6 rounded-2xl border border-white/10 bg-white/5 hover:bg-white/10 hover:scale-[1.02] transition-all duration-200 text-left transform ${
          ...
          >
            <div className="flex items-center gap-4 mb-3">
              ...
              <div className="text-lg font-medium">Desktop Dashboard</div>
            </div>
            <div className="text-sm text-white/60 ml-12">
              Management interface for tracking employee engagement and implementing solutions
            </div>
          </button>
        </Link>
      </div>
