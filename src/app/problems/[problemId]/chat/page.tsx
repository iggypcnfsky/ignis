	...
	const [messages, setMessages] = useState<ChatMessage[]>([
		{
			...
			role: "other",
			text:
				"Hey everyone! Just saw the broken bench by the pond — looks dangerous 😬 Anyone know if it's been reported already?",
		},
		{
			id: "m2",
			role: "other",
	...
	return (
		<div className="flex flex-col h-dvh w-full bg-[#141414] text-white">
			...
			<div className="relative z-10 px-3 pt-20 pb-2 flex-shrink-0">
				<ProblemPillNav problemId={problem.id} active="chat" />
			</div>
